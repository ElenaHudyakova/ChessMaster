...
#               board_state[(to_point.file, from_point.rank)].color != board_state[(from_point.file, from_point.rank)].color
    ...
    def is_move_possible(self, board_state, from_point, to_point):
        if board_state[(to_point.file,to_point.rank)] is None\
            ...
            return False#self.is_en_passant_possible(board_state, from_point, to_point)
...
class BishopMotionStrategy(MotionStrategy):
    def _is_path_clear(self, board_state, from_point, to_point):
        ...
        while current_point!=to_point:
            if not (board_state[(current_point.file, current_point.rank)] is None):
                return False
            current_point.file += file_direction
            current_point.rank += rank_direction
        return True
    ...
    def _can_move(self, board_state, from_point, to_point):
        if math.fabs(from_point.file-to_point.file) == math.fabs(from_point.rank-to_point.rank) \
                and (self._is_path_clear(board_state, from_point, to_point)):
            return True
        else:
            return False
...
class RookMotionStrategy(MotionStrategy):
    ...
    def _can_move(self, board_state, from_point, to_point):
        if (from_point.file == to_point.file or from_point.rank == to_point.rank) and (self._is_path_clear(board_state, from_point, to_point)):
            return True
        else:
            return False
...
class QueenMotionStrategy(MotionStrategy):
    ...
    def is_move_possible(self, board_state, from_point, to_point):
        ...
        if board_state[(to_point.file,to_point.rank)] is None\
        and (rook_strategy._can_move(board_state, from_point, to_point) or bishop_strategy._can_move(board_state, from_point, to_point)):
            return True
        else:
            return False
